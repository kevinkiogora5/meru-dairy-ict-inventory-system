...
namespace Mcdcu\Projects\services\Helper;

use Exception;
use PHPMailer\PHPMailer\PHPMailer;

class PasswordResetHelperService
{
    ...
    public static function sendRestPasswordEmail($usersData, $reset_token)
    {
        ...
        $userName = htmlspecialchars($usersData->first_name, ENT_QUOTES, 'UTF-8');
    ...
    public static function sendRestBuyerPasswordEmail($usersData, $reset_token)
    {
        ...
        try {
            ...
            $mail->isHTML(true);
            $mail->Subject = "Password Reset Request - " . strtoupper($recipientEmail);
            $mail->Body = "<div style='font-family: Arial, sans-serif; color: #333; line-height: 1.6; max-width: 600px;'>
                <p style='font-size: 16px;'>Dear <strong>$userName</strong>,</p>
                <p>We have received a request to reset your password!</p>
                <p>Please clik on the link below to reset your password.</p>
                <a href='" . $_ENV['base_site_url'] . "/buyer/reset_password?token=" . $reset_token . "' style='background-color: #337ab7; color: #fff; padding: 10px 15px; text-decoration: none;'>Reset Password</a>
                <h4 style='font-size: 16px; font-weight: bold;'>NOTE: This link expires after 30 minutes</h4>
                <p>If you did not make this request, ignore this mail.</p>
    ...
    public static function sendRestPasswordEmailOTP($usersData, $reset_token)
    {
        ...
        try {
            ...
            // Email Content
            $mail->isHTML(true);
            $mail->Subject = "System Access OTP - " . strtoupper($recipientEmail);
            $mail->Body = "
            <div style='font-family: Arial, sans-serif; color: #333; line-height: 1.6; max-width: 600px;'>
                <p style='font-size: 16px;'>Dear <strong>$userName</strong>,</p>
                <pTo proceed to CPC system, please enter the OTP below!</p>
                <p>OTP:<h1> $reset_token </h1> </p>
                <h4 style='font-size: 16px; font-weight: bold;'>NOTE: This code expires after 10 minutes</h4>
                <p>If you did not make this request, ignore this mail.</p>
